          ...
          <div class="u-container-style u-group u-radius-50 u-shape-round u-white u-group-1">
            <div class="u-container-layout u-valign-middle u-container-layout-1">
              <div class="u-align-center u-form u-form-1">
                <form action="#" method="POST" class="u-clearfix u-form-spacing-2 u-form-vertical u-inner-form" style="padding: 0px;" source="custom" name="form">
                  ...
                  <div class="u-form-group u-form-name u-form-group-3">
                    ...
                    <input type="text" placeholder="" id="name-f2a8" name="nome" class="u-border-1 u-border-custom-color-11 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-lobster u-input u-input-rectangle u-input-3" required=""></input>
                  </div>
                  <div class="u-form-email u-form-group u-form-partition-factor-2 u-form-group-4">
                    ...
                    <input type="email" placeholder="Entre com seu email" id="email-f2a8" name="email" class="u-border-1 u-border-custom-color-11 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-lobster u-input u-input-rectangle u-input-4" required=""></input>
                  </div>
                  <div class="u-form-address u-form-group u-form-group-5">
                    ...
                    <input type="text" placeholder="Entre com uma senha para sua conta" id="address-de88" name="cep" class="u-border-1 u-border-custom-color-11 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-lobster u-input u-input-rectangle u-input-5" required=""></input>
                  </div>
                  ...
                  <div class="u-form-group u-form-partition-factor-3 u-form-group-9">
                    ...
                    <input type="text" placeholder="Insira seu email" id="text-6bfd" name="cidade" class="u-border-1 u-border-custom-color-11 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-lobster u-input u-input-rectangle u-input-9"></input>
                  </div>
                  ...
                  <div class="u-align-center u-form-group u-form-submit u-form-group-13">
                    <a href="c" class="u-btn u-btn-round u-btn-submit u-button-style u-custom-color-8 u-radius-3 u-btn-1">Submit</a>
